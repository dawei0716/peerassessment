...
//import Professor { ReactComponent as Prof } from '../../Assets/professor.svg';
//import Student { ReactComponent as Stud } from '../../Assets/student.svg';
                    ...
                    >
                        <CardActionArea style={{display:'flex',flexDirection:'row', padding:20, justifyContent:'space-around'}} onClick={()=>props.clickTypeHandler('Student')}>
                            {/* <div style={{backgroundColor:'#F9A826'}}> */}
                                <img src={Student} title="Contemplative Reptile" alt='student' style={{width:'35%'}}/>
                            {/* </div> */}
